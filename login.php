...
<h2 style="margin-left:50px;" background-color:#25ad9f;>Sign in</h2>
<form name="form" method="post" onsubmit="return validation()" style="margin-left:400px;">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" id="email" name="email" placeholder="Enter Your Email" style="width:350px; height:50px; margin-top:-10px;">
      </div>
    </div>
    
    <div class="form-group">
      <label class="control-label col-sm-2" for="pwd" style="margin-top:15px;">Password:</label>
      <div class="col-sm-10">
        <input type="password" class="form-control" id="pwd" name="pass" placeholder="Enter Password" style="width:350px; height:50px; margin-top:5px;">
      </div>
    </div>
    
    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10">
        <input type="submit" class="btn btn-default" id="submitMain" name="but" value="Submit" style="margin-left:-420px; margin-top:10px; width:200px; background-color:#25ad9f;">
      </div>
    </div>
  </form>
</div>
