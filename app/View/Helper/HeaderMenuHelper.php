					...
					if(isset($value['children']) && !empty($value['children'])){
						...
						if($show_image == 1){
							if(isset($header_menus['image']) && !empty($header_menus['image'])){
								if($header_menus['open_as'] == 'List' || $header_menus['open_as'] == 'Page'){
									echo $this->Html->link($this->Html->image('../uploads/photos/' . $header_menus['image'], array('class' => 'yamm_img')), array('plugin' => false, 'controller' => 'articles', 'action' => 'index', $page_slug), array('escape' => false));
								}
								else
								{
										
									die('hjhjh');
									echo $this->Html->link($this->Html->image('../uploads/photos/' . $header_menus['image'], array('class' => 'yamm_img')),$header_menus['url_action'], array('target'=>'_blank','escape'=>false));


									//echo $this->Html->link($this->Html->image('../uploads/photos/' . $header_menus['image'], array('class' => 'yamm_img')), array(), array('escape' => false));	
								}
						...
						if($show_image == 1){
							if(isset($header_menus['image']) && !empty($header_menus['image'])){
								...
								else if($header_menus['open_as'] == 'Page')
								{
									echo $this->Html->link($this->Html->image('../uploads/photos/' . $header_menus['image'], array('class' => 'yamm_img')), array('plugin' => false, 'controller' => 'articles', 'action' => 'index', $page_slug), array('escape' => false));
								}
								else
