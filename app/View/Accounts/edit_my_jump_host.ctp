  ...
  <div class="container">
     <div class="row">
		...
		<div class="col-md-9 col-sm-9">
          <h3 class="title">Edit Jump Rentals</h3>
		<?php echo $this->Form->create('JumpHost',array('class'=>'form-horizontal ajax_form','type'=>'file')); ?>
			...
			<div class="form-group">
				<div class="form-group">
					...
					<div class="col-sm-8">
					  <?php echo $this->Form->text("JumpHost.zipcode",array('class'=>'form-control','label'=>false,'placeholder'=>'Enter Jump Title')); ?>
					</div>
				</div>
			</div>
			<div class="col-md-12">
				<div class="form-group">
					...
					<div class="col-sm-8">
					  <?php echo $this->Form->textarea("JumpHost.bedrooms",array('class'=>'form-control','label'=>false,'placeholder'=>'Enter Number of Bedrooms')); ?>
					</div>
				</div>
			</div>
			<div class="col-md-12">
				<div class="form-group">
					...
					<div class="col-sm-8">
					  <?php echo $this->Form->text("JumpHost.beds",array('class'=>'form-control','label'=>false,'placeholder'=>'Enter Number of Beds')); ?>
					</div>
				</div>
			</div>
			<div class="col-md-12">
			...
			<div class="col-md-12">
				<div class="form-group">
				<label class="col-sm-4 control-label" for="mapCanvas"></label>
					<div class="col-sm-8">
