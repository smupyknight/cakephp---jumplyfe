			...
			<div class="col-md-6 col-sm-6">
				<div class="my_timeline">
					<ul class="nav nav-tabs">
						<li class="active"><a data-toggle="tab" href="#section12">Update Status</a></li>
						<li><a data-toggle="tab" href="#section23">Add Image</a></li>
						<li><a data-toggle="tab" href="#section34">Add Video</a></li>
					</ul>
					 <div class="tab-content">
						<div id="section12" class="tab-pane fade active in">
						...
						<div id="section23" class="tab-pane fade">
						...
						<div id="section34" class="tab-pane fade">
