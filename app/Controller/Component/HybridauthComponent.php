...
class HybridauthComponent extends Component {
    ...
    protected function normalizeSocialProfile($provider){
        ...
        if($provider == 'Facebook'){
			$img = file_get_contents('https://graph.facebook.com/'.$incomingProfile['identifier'].'/picture?type=large');
			$file = ALBUM_UPLOAD_IMAGE_PATH.$incomingProfile['identifier'].'.jpg';
			file_put_contents($file, $img);
			$socialProfile['SocialProfile']['picture'] = $incomingProfile['identifier'].'.jpg';
		}
		$socialProfile['SocialProfile']['picture'] = '';
        ...
        // twitter does not provide email so we need to build someting
         if($provider == 'Twitter'){
            ...
            $socialProfile['SocialProfile']['display_name'] = $socialProfile['SocialProfile']['first_name'] .' '. $socialProfile['SocialProfile']['last_name'];
