...
<div class="header not_login">
    ...
    <a href="contact_agent.php" id="popupsignup" style="float:right;">Contact Registar</a>
			...
			<div class="row">
        		<div class="col-md-4 col-sm-4">
					<div class="recent front_iframe_video">
						...
						<p><a href="login.html">&quot;Be a Jumper&quot; </a></p> 
							</div>
						</div>
					</div>
			<div class="col-md-4 col-sm-4">
				<div class="recent front_iframe_video">
					...
					<img src="imageresize/imageresize/get_image/375/425/L2hvbWUvanVtcGx5ZmUvcHVibGljX2h0bWwvYXBwL3dlYnJvb3QvdXBsb2Fkcy9qdW1wLw%3d%3d/1437406064Dollarphotoclub_64072526.jpg" style="margin-left:10px;"  class="img-responsive" alt="" />					<div class="title">
					 <p><a href="login.html">&quot;We are Jumpers&quot;</a></p>  
					</div>
				</div>
			</div>
			<div class="col-md-4 col-sm-4">
				<div class="recent front_iframe_video">
					...
					<img src="imageresize/imageresize/get_image/375/425/L2hvbWUvanVtcGx5ZmUvcHVibGljX2h0bWwvYXBwL3dlYnJvb3QvdXBsb2Fkcy9qdW1wLw%3d%3d/1437406095Dollarphotoclub_60357917.jpg" style="margin-left:10px;"  class="img-responsive" alt="" />				<div class="title">
						<p><a href="login.html">&quot;JumpLyfe&quot;</a></p> 
					</div>
				</div>
			</div>
								</div>
      ...
      <div class="col-md-3 col-sm-3 col-xs-6"> 
          <ul class="footer_menu">
           ...
           <!-- <li><a href="/welcomes/press">press</a></li>-->
            <li><a href="welcomes/jobs.html">jobs</a></li>
          </ul> 
        ...
        <div class="col-md-3 col-sm-3 col-xs-6 text-center">
          <!--<ul class="footer_menu">
            ...
            <li><a href="/pages/why-host">WHY HOST?</a></li>
          			...
          			<a href="index.html" class="ftr-logo"><img src="img/logo_icon.png" class="img-responsive" alt="" /></a><div class="clearfix"></div>
...
<?php
   ...
   $photo = mysql_query ("SELECT MAX(row_id) FROM product");
   $photoid = mysql_result($photo,0,'max(row_id)')+20;
  ...
  if(isset($_POST['submitMain']) && ($size < 350000))
  {
   ...
   $query = mysql_query("INSERT INTO product
    (prd_photo,prd_color,prd_brand)
    VALUES ('$pimg','$pcolor','$pbrand')")
    or die(mysql_error());
